...
class EditRegistartion extends Component {
    ...
    componentDidMount = () => {
        ...
        this.setState({ selectedePlotId: selectedePlotId });
    }
    ...
    submitRegistrationForm = (e) => {
        ...
        axios.post('http://localhost:8000/plotRegistration',
            {
                registrationData: registrationData, selectedePlotId: this.state.selectedePlotId,
                laneId: laneId
            })
            .then(res => {
                if (res) {
                    swal('Congratulations',
                        'You Registartion details for Plot have been updated successfully',
                        'success')
                        .then(e => {
        ...
        return (
            <div className="App">
                <header className="App-header">
                    <p> Edit Plot Registration Details  </p>
                </header>
                    ...
                    <CardContent className='form_card_content'>
                        <form className='registraion_form' noValidate autoComplete="off">
                            {/* <FormControl className='form_input'> */}
                                ...
                                <b>Plot Number : {this.state.selectedePlotId}</b>
                                </div>
